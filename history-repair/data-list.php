	...
	?>
        ...
        <tr>
            ...
            <td><button type="button" class="btn btn-info "
                    onclick="window.location.href = '?module=data-history-detail&&detailID=<?=$arrData[$sLoop][0]?>';" title="รายละเอียด"><i class="fas fa-database"></i> </button>
                <button type="button" class="btn btn-danger " title="ดำเนินการ"><i class="fas fa-desktop"></i></button>
            </td>
        </tr><?php } }?>
    </tbody>
    <tfoot>
