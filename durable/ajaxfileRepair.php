    ...
    <div class="card-body ">
        <form method="post" action="?module=resive-repair">
            <div class="form-group">
                ...
                <input type="password" class="form-control" name="password" placeholder="เลขทะเบียน">
            </div>
            <div class="form-group">
                <br>
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" name="password" placeholder="คำอธิบายหรือหมายเหตุเพิ่มเติม">
            </div>
            <div class="row">
                <div class="col-sm-5">
                </div>
